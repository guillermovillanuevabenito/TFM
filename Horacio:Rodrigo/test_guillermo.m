...
for SpkFreqin = SpkFreqin_range
    ...
    tspk_jit = tspk; 
    tspk_jit(8:end) = tspk_jit(8:end)+randn(1,length(tspk_jit(8:end)))*(9/4)*SpkPerin;
    ...
    figure
    hold on
    plot(t,V_pos_anl-60,'-b','linewidth',2);
    hold on
    plot(tpeak_pos_anl,Vpeak_pos_anl-60,'ro','linewidth',2,'MarkerSize',8)
    plot(tlow_pos_anl,Vlow_pos_anl-60,'go','linewidth',2,'MarkerSize',8)
...
legend('Periodic','Jittered','Numerical','Analytical','','','')
