function [fitresult, gof] = f_alphafit3(t, y,aux)
...
ft = fittype( 'conv_with_kernel2(x,a,b,c,aux)', 'coefficients', {'a','b','c'},'independent', 'x','dependent', 'y','problem','aux');
...
% Fit model to data.
[fitresult, gof] = fit( xData, yData, ft, opts,'problem',{aux} );
